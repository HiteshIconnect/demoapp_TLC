...
const InstallationCamera = ({
  ...
  const saveImagesAndGo = async () => {
    ...
    await navigation.navigate('InstallationStatus', {
    ...
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'column', flex: 0.6}}>
            ...
            photos.map(photo => {
              return (
                <View style={{flex: 0.4}} key={photo.path}>
                  <TouchableOpacity
                    onPress={() => deletePhoto(photo.path)}
                    style={{
                      position: 'absolute',
                      top: 0,
                      right: 0,
        ...
        </View>
        {
          ...
          <TouchableOpacity
            disabled={isDisabled}
            onPress={() => saveImagesAndGo()}
            style={{
              flex: 0.6,
              backgroundColor: click ? '#E11D38' : 'gray',
            ...
            <Text style={{fontSize: 16, fontFamily: 'Poppins', color: 'white'}}>
              {isDisabled === true ? 'Saving...' : 'Save'}
            </Text>
          </TouchableOpacity>
          //:
          //null
