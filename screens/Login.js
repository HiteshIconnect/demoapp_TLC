...
import { Image,Text,View,TextInput,TouchableOpacity,Animated,Easing,TouchableWithoutFeedback,Keyboard,StyleSheet} from "react-native";
...
import { selectCurrentUser, selectToken, getTokenValid, selectRememberMe, sendUserDetails,
}from "../redux/user/selector";

const Login = ({ navigation,loginUser,currentUser,remember,setError,userDetails,setEnv}) => {
    ...
    <>
      ...
      <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
        <View style={styles.container}>
          <Animated.View  
            style={[{ transform: [{ translateY: startValue }] },
            styles.logoStyle]}
          >
            <Image source={logo} style={styles.logoSize} />
          </Animated.View> 

          <Animated.View style={[styles.opacityAnimatedContainer,{opacity:opacityVal}]}>
            ...
            <View style={{flexDirection:'row',justifyContent:'flex-start',marginTop:20}}>
              ...
              <TouchableOpacity onPress={()=>setRememberMe(!rememberMe)}>
                <Text style={{marginLeft:10,marginTop:2,fontFamily:'Poppins'}}>Remember Me</Text>
              </TouchableOpacity>
            </View>
            ...
            >
              <Text style={[styles.poweredText, styles.buttonText]}>
                Login
              </Text>
            </TouchableOpacity>
          </Animated.View>

          <Animated.View style={[styles.powererdByOpacityContainer ,{opacity:opacityVal}]}>
              ...
              >
                iConnect Info Solutions v1.32.0
              </Text>
              <Text
              style={{fontFamily:'Poppins',justifyContent:"center",textAlign:'center',color:"#BEBEBE"}}
              >BaseURL: "{baseURL}"(sandbox)</Text>
          </Animated.View>
