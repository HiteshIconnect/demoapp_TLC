...
import {storeInstallList,storeImageDropBox} from '../redux/installation/actions'
import {salesOrderNoI} from '../redux/barcodeScanner/selector'

function CaptureImage({changeSelectedItem,expand,handerExpand,imageSource,item,list,screen,salesOrderNoI,selectItem,storeImageDropBox,storeInstallList,toggleCaptureModal}) {
